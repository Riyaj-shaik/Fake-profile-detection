...
cases = [
    {
        'name': 'freebitcoin_now',
        'screen_name': 'getmoney_fast',
        'description': 'Win Bitcoin now! Click link and get rich fast',
    ...
    {
        'name': 'Jessica Martin',
        'screen_name': 'jessica_martin',
        'description': 'Product manager, traveler, coffee lover. Sharing thoughts on tech and life.',
        'created_at': 'Mon Apr 15 14:20:10 +0000 2014',
